...
v0.new("<Color=Cyan>Welcome to HC Hub<Color=/>"):Display();
wait(0.5);
...
v5.Window = function(v134, v135)
	...
	v170.Image = "http://www.roblox.com/asset/?id="   .. tostring(86718689170693) ;
...
v8.Image = "rbxassetid://86718689170693";
v8.Draggable = true;
...
game:GetService("StarterGui"):SetCore("SendNotification", {
	Title = "Subscribe for HCROBLOX",
	Text = "Loading...",
	Icon = "rbxthumb://type=Asset&id=86718689170693&w=150&h=150",
	Duration = 10
});
spawn(function()
	while wait() do
